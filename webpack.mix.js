...
mix.js('resources/js/app.js', 'public/js')
    ...
    .sass('resources/sass/components/cards.scss', 'public/css')
    ...
    .sass('resources/sass/dashboard/expenses.scss', 'public/css') 
    .sass('resources/sass/dashboard/reminder.scss', 'public/css')
